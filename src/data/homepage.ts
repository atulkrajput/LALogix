...
export const heroContent = {
  ...
  subheadline:
    'LALogix builds industry-specific platforms for schools, retail businesses, and dairy farms. Streamline operations, reduce costs, and grow with confidence.',
  ctaButtons: [
...
export const founderInfo = {
  ...
  title: 'Founder & CEO',
  description:
    'With over 15 years of experience in software development and business automation, our founder started LALogix with a simple mission — to make powerful automation accessible to businesses of all sizes. Based in Dehradun, India, LALogix has grown from a small team to a trusted technology partner for schools, retailers, and dairy farms across the country.',
...
export const ctaContent = {
  ...
  subheadline:
    'Join hundreds of organizations that trust LALogix to streamline their operations. Book a free demo today.',
